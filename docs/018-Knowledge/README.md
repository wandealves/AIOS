...
Módulo: 018-Knowledge
Status: Skeleton
Versão: 0.1
Última atualização: 2026-07-20
Responsável (RACI-A): A definir na fase de fan-out
Depende de: 005,019,010
---

# AIOS — Módulo 018 · Knowledge

> **Propósito.** Gerência de conhecimento: ingestão, curadoria, versionamento e consulta.
...
Este módulo depende de: **005,019,010**. Reutilize as definições do
