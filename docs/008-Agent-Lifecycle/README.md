...
Depende de: 006,009,010
---

# AIOS — Módulo 008 · Agent Lifecycle

> **Propósito.** Ciclo de vida do agente: spawn, ready, running, suspended, migrated, terminated; hibernação de cold agents.
...
Este módulo depende de: **006,009,010**. Reutilize as definições do
