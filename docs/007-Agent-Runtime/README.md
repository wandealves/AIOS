...
Depende de: 006,015,017,021
---

# AIOS — Módulo 007 · Agent Runtime

> **Propósito.** Plano de dados (Python): execução isolada do agente, loop cognitivo (ReAct), host MCP e sandbox.
...
Este módulo depende de: **006,015,017,021**. Reutilize as definições do
