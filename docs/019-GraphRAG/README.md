...
Depende de: 018,005,017
---

# AIOS — Módulo 019 · GraphRAG

> **Propósito.** Recuperação aumentada por grafo (Apache AGE): construção, consulta e ranqueamento.
...
Este módulo depende de: **018,005,017**. Reutilize as definições do
