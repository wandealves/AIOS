...
# AIOS — Módulo 038 · Patents

> **Propósito.** Propriedade intelectual: invenções candidatas, prior art e estratégia.
...
Este módulo depende de: **037**. Reutilize as definições do
