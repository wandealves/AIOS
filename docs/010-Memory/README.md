...
Depende de: 005,011,023,002(ADR-0007)
---

# AIOS — Módulo 010 · Memory

> **Propósito.** Memória hierárquica de 7 camadas com retenção, consolidação e esquecimento.
...
Este módulo depende de: **005,011,023,002(ADR-0007)**. Reutilize as definições do
