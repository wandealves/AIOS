...
ADRs relacionados: ADR-0200..0209 (a propor); ADR-0004, ADR-0006, ADR-0008, ADR-0010 (globais)
RFCs relacionados: RFC-0001; RFC-0200, RFC-0201 (a propor)
Depende de: 001,002(ADR-0004),003,005,021,022,024,025,027,028
---

# AIOS — Módulo 020 · Communication

> **Propósito.** Barramento (NATS): pub/sub, request/reply, streams, A2A e comunicação seletiva.
...
Este módulo depende de: **001-Architecture**, **002-ADR (ADR-0004)**,
**005-Database** (schema `comm` e contrato de outbox), **021-Security** (contas
NKey/JWT, mTLS), **022-Policy** (PDP), **024-Observability**, **025-Audit**,
**027-Cluster** (supercluster/leaf nodes), **028-Deployment**. É usado como
barramento por `004`, `006`–`019`, `022`, `023`, `025` e `026`. Reutilize as definições do
