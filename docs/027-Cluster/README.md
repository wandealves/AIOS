...
# AIOS — Módulo 027 · Cluster

> **Propósito.** Cluster, alta disponibilidade e disaster recovery: sharding, failover, quorum, RTO/RPO.
...
Este módulo depende de: **001,028**. Reutilize as definições do
