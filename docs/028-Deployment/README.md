...
# AIOS — Módulo 028 · Deployment

> **Propósito.** Empacotamento e implantação: Docker/Compose, topologia, recursos, rollout e gateway (YARP).
...
Este módulo depende de: **027,029**. Reutilize as definições do
