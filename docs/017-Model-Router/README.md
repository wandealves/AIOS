...
Módulo: 017-Model-Router
Status: Skeleton
Versão: 0.1
Última atualização: 2026-07-20
Responsável (RACI-A): A definir na fase de fan-out
Depende de: 026,011,002(ADR-0009)
---

# AIOS — Módulo 017 · Model Router

> **Propósito.** Roteamento multiobjetivo de LLMs (custo×qualidade×latência) com drivers de provedor.
...
Este módulo depende de: **026,011,002(ADR-0009)**. Reutilize as definições do
