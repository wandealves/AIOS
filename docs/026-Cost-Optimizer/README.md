...
Módulo: 026-Cost-Optimizer
Status: Skeleton
Versão: 0.1
Última atualização: 2026-07-20
Responsável (RACI-A): A definir na fase de fan-out
Depende de: 017,009,011
---

# AIOS — Módulo 026 · Cost Optimizer

> **Propósito.** Otimização de custo de inferência: orçamento, cotas, cache e sinal para Scheduler/Model Router.
...
Este módulo depende de: **017,009,011**. Reutilize as definições do
