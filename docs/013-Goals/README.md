...
# AIOS — Módulo 013 · Goals

> **Propósito.** Gerência de objetivos: representação declarativa, restrições e critérios de sucesso.
...
Este módulo depende de: **012,022**. Reutilize as definições do
