...
Módulo: 036-Experiments
Status: Skeleton
Versão: 0.1
Última atualização: 2026-07-20
Responsável (RACI-A): A definir na fase de fan-out
Depende de: 035,010,009
---

# AIOS — Módulo 036 · Experiments

> **Propósito.** Plano experimental (memória hierárquica, roteamento, coordenação, recuperação de falhas).
...
Este módulo depende de: **035,010,009**. Reutilize as definições do
