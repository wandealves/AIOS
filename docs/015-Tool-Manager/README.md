...
Módulo: 015-Tool-Manager
Status: Skeleton
Versão: 0.1
Última atualização: 2026-07-20
Responsável (RACI-A): A definir na fase de fan-out
Depende de: 021,022,016
---

# AIOS — Módulo 015 · Tool Manager

> **Propósito.** Driver manager de ferramentas: registro, permissões, versão, métricas e invocação via MCP.
...
Este módulo depende de: **021,022,016**. Reutilize as definições do
