...
Depende de: 001,022,009,008
---

# AIOS — Módulo 006 · Kernel

> **Propósito.** Núcleo cognitivo: syscalls, Agent Control Block, cotas, capability enforcement e coordenação de ciclo de vida.
...
Este módulo depende de: **001,022,009,008**. Reutilize as definições do
