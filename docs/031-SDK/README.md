...
Depende de: 004,007,015
---

# AIOS — Módulo 031 · SDK

> **Propósito.** SDKs (.NET/Python): modelo de programação de agentes, tools e memória.
...
Este módulo depende de: **004,007,015**. Reutilize as definições do
