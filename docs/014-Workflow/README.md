...
Depende de: 020,009,025
---

# AIOS — Módulo 014 · Workflow

> **Propósito.** Motor de workflow determinístico: sagas, compensação, DLQ e orquestração de tarefas.
...
Este módulo depende de: **020,009,025**. Reutilize as definições do
