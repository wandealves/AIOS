...
Depende de: 010,012,024
---

# AIOS — Módulo 023 · Learning

> **Propósito.** Aprendizado contínuo: consolidação de experiência, geração de políticas e rollback (anti catastrophic forgetting).
...
Este módulo depende de: **010,012,024**. Reutilize as definições do
