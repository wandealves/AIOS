...
Módulo: 016-Plugin-System
Status: Skeleton
Versão: 0.1
Última atualização: 2026-07-20
Responsável (RACI-A): A definir na fase de fan-out
Depende de: 015,017,021
---

# AIOS — Módulo 016 · Plugin System

> **Propósito.** Extensões carregáveis (drivers/plugins) sem alterar o kernel: contrato, sandbox e versionamento.
...
Este módulo depende de: **015,017,021**. Reutilize as definições do
