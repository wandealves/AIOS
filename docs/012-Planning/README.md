...
Depende de: 013,010,017
---

# AIOS — Módulo 012 · Planning

> **Propósito.** Motor de planejamento: decomposição de objetivos, replanejamento e estratégias (ReAct/Reflexion/tree).
...
Este módulo depende de: **013,010,017**. Reutilize as definições do
